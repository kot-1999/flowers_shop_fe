...
export default function OrderList({ 
    ...
    const [orderUpdated, setOrderUpdated] = useState<any>(null)
    ...
    return (
        <Flex vertical gap={16}>
            {orders.map((orderItem) => {
                ...
                if (orderUpdated?.id === orderItem.id) {
                    order = orderUpdated
                }
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        £{Number(Number(order.shippingPrice) + Number(order.productsPrice)).toFixed(2)}
                                    </Text>
                                </Flex>
                            </Flex>
